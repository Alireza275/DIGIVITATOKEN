...
contract DIGIVITA is Token {
    ...
    uint private constant BUSD_DAILYPROFIT  = 40;
    uint private constant TOKEN_DAILYPROFIT = 60;
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = msg.sender;                                  // e
        DEV_2 = 0xF564cC721988379bC11657609b021380e13BEDd1;  // N
        ADV_1 = 0xf19Ec827011FA474c695B2EF7ecd18a49Befa095;  // 0         
        ADV_2 = 0xE9CfED9B3B8781a2FE272e951cA7c3c93bc291C4;  // E        
        ADV_3 = 0x8eD9B79ae34642ba1a723E83670Cc12dD5D4A470;  // o     
        FIN_1 = 0x4eA944b829e319312B9863E04100A020D0525591;  // S   
        MAR_1 = 0x3B496986d8ebF9b558167593dD101435e2f5B4e9;  // DESB      
    ...
    function stakeBUSD(address referrer,  uint256 _amount) public payable {
        require (block.timestamp > 1643119200);                // January 25, 2022 2:00:00 PM GMT
